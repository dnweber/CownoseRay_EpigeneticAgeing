...
#Importing Data
tmp_out <- read.table("confintervals_BBRF_MU_split.txt", head=F)
tmp_col <- read.table("confintervals_BBRF_MU_data_names.txt", head=F)
...
save(out, file="confintervals_BBRF_MU_complete")
